...
import type { Admin, AdminStatusUI } from "@/types/admin";
import { computeAdminStatus } from "@/types/admin";
...
export function AdminStatusBadge({
  ...
  const s: AdminStatusUI =
    status ?? (admin ? computeAdminStatus(admin) : "active");
  const m = META[s];
  return (
    <span
      className={[
